...
<body>
    <div class="container">
        <header class="header">
            <h1 class="title">📁 Data Classifier - <span id="filename">Loading...</span> (<span id="progress">0/0</span>)</h1>
            <div class="mode-indicator">
                <span id="markdown-indicator" class="mode-badge hidden">📝 Markdown</span>
            </div>
        </header>
        ...
        <section class="status">
            <div class="status-indicator">
                Status: <span id="classification-status" class="status-text">⚪ Unclassified</span>
            </div>
        ...
        <footer class="navigation">
            ...
            <div class="stats">
                ...
                <span id="stats-skipped" class="stat">⏭0</span>
                <span id="stats-remaining" class="stat">⏳0</span>
            </div>
        </footer>
    </div>
        ...
        <div class="help-content">
            ...
            <div class="help-body">
                ...
                <div class="help-section">
                    ...
                    <div class="shortcut-list">
                        <div class="shortcut-item">
                            <kbd>←</kbd> <kbd>→</kbd> or <kbd>J</kbd> <kbd>K</kbd>
                            <span>Navigate between items</span>
                        </div>
                        <div class="shortcut-item">
                            <kbd>Shift</kbd> + <kbd>←</kbd> <kbd>→</kbd> or <kbd>Shift</kbd> + <kbd>J</kbd> <kbd>K</kbd>
                ...
                <div class="help-section">
                    ...
                    <div class="shortcut-list">
                        <div class="shortcut-item">
                            <kbd>⌘</kbd> + <kbd>M</kbd> <small>(or Ctrl+M)</small>
                            <span>Toggle markdown rendering mode</span>
                        </div>
                        <div class="shortcut-item">
                            <kbd>⌘</kbd> + <kbd>E</kbd> <small>(or Ctrl+E)</small>
